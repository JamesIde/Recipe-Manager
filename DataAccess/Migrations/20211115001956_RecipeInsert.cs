...
{
    public partial class RecipeInsert : Migration
    {
...
(SELECT	2, 'Flake and Chips',		'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt.',												'2021-09-02 14:58:00.000', '2021-09-03 08:12:00.000' WHERE NOT EXISTS (SELECT 1 FROM Recipes WHERE Id = 2)) UNION ALL
(SELECT	3, 'Sausage Roll',	'Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.',		'2021-08-31 11:39:00.000', '2021-09-01 09:40:00.000' WHERE NOT EXISTS (SELECT 1 FROM Recipes WHERE Id = 3));
